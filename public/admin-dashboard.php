...
<body>
    <div class="container">
        <nav class="navbar">
            <div class="logo" img="" alt="logo">IdVaut | Admin</div>
            <ul>
            ...
            <div class="requests-list">
                ...
                <div class="request-card" data-doc-id="<?= $document['id'] ?>">
                    ...
                    <div class="request-actions">
                        ...
                        <button class="action-btn view" data-doc-id="<?= $document['id'] ?>">
        ...
        btn.addEventListener('click', async function() {
            ...
            try {
                ...
                if (result.success) {
                    ...
                    card.querySelector('.request-status').textContent = `Status: ${action === 'approve' ? 'Approved' : 'Rejected'}`;
                    card.querySelector('.request-status').className = `request-status ${action === 'approve' ? 'approved' : 'rejected'}`;
