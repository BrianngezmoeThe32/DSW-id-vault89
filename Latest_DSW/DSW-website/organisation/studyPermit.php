...
<head>
    ...
    <title>Study Permit Application - IdVault</title>
    ...
    <div class="container">
        ...
        <main>
            <section class="application-form">
                <h1>Study Permit Application</h1>
                <form action="process_study_permit.php" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="form-group">
                        <label for="acceptance_letter">Letter of Acceptance:</label>
                        <input type="file" id="acceptance_letter" name="acceptance_letter" accept=".pdf,.doc,.docx" required>
                    </div>
